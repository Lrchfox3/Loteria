...
// </editor-fold>
    ...
    public void iniciarConexion() throws SQLServerException, Exception {
        ...
        if (cnn != null) {
            System.out.println("Conexión a base de datos " + this.getNombreBaseDatos() + " ... Ok");
            cnn.setAutoCommit(false);
            CnnBD.setCnn(cnn);
        }        
    }

    public void iniciarConexion(String servidor, String bdd, String app, String user, String pass, int puerto) throws SQLServerException, Exception {
        this.setNombreServidor(servidor);
        this.setNombreBaseDatos(bdd);
        this.setNombreAplicacion(app);
        this.setUsuario(user);
