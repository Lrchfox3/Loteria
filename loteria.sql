...
-- Volcando estructura de base de datos para loteria
...
-- Volcando datos para la tabla loteria.numero_generado: ~15 rows (aproximadamente)
...
-- Volcando datos para la tabla loteria.numero_sorteo: ~440 rows (aproximadamente)
...
INSERT INTO `numero_sorteo` (`codigo`, `numero`, `fecha`) VALUES
	...
	(439, '01 - 02 - 09 - 12 - 13 - 16', '0013-11-13 00:00:00'),
...
CREATE TABLE `v_estadistica` (
	`numero` VARCHAR(2) NULL COLLATE 'utf8_general_ci',
...
CREATE TABLE `v_numeros` (
	`numero` VARCHAR(2) NULL COLLATE 'utf8_general_ci',
	`tipo` VARCHAR(1) NOT NULL COLLATE 'utf8_general_ci',
...
-- Creando tabla temporal para superar errores de dependencia de VIEW
CREATE TABLE `v_numeros_loteria` (
	`numero` VARCHAR(128) NULL COLLATE 'utf8_general_ci',
	`fecha` DATETIME NULL,
	`TIPO` VARCHAR(1) NOT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
-- Creando tabla temporal para superar errores de dependencia de VIEW
CREATE TABLE `v_numero_repetidos` (
	`numero` VARCHAR(2) NULL COLLATE 'utf8_general_ci',
	`repeticion` BIGINT(21) NOT NULL,
	`tipo` VARCHAR(1) NOT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
-- Creando tabla temporal para superar errores de dependencia de VIEW
CREATE TABLE `v_numero_repetidos_generados` (
	`numero` VARCHAR(2) NULL COLLATE 'utf8_general_ci',
	`repeticion` BIGINT(21) NOT NULL,
	`tipo` VARCHAR(1) NOT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
-- Creando tabla temporal para superar errores de dependencia de VIEW
CREATE TABLE `v_numero_repetidos_posicion` (
	`numero` VARCHAR(2) NULL COLLATE 'utf8_general_ci',
	`repeticion` BIGINT(21) NOT NULL,
	`tipo` VARCHAR(1) NOT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
-- Creando tabla temporal para superar errores de dependencia de VIEW
CREATE TABLE `v_numero_repetidos_sorteo` (
	`numero` VARCHAR(2) NULL COLLATE 'utf8_general_ci',
	`repeticion` BIGINT(21) NOT NULL,
	`tipo` VARCHAR(1) NOT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
-- Creando tabla temporal para superar errores de dependencia de VIEW
CREATE TABLE `v_repeticiones_numeros` (
	`numero` VARCHAR(2) NULL COLLATE 'utf8_general_ci',
	`posicion` BIGINT(20) NOT NULL,
	`tipo` VARCHAR(1) NOT NULL COLLATE 'utf8_general_ci',
	`repeticiones` BIGINT(21) NOT NULL
) ENGINE=MyISAM;
